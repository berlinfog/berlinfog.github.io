...
<h6>6.修改一堆AnyQ/cmake/external，部分换成gitee仓库加快一丢丢可怜的速度。
...
<h6>11.需要换个新的数据集测试的往下看



<h6>12.windows往阿里云上传文件：
...
<h6>14.将灌库文件faq_file(utf8编码)转换成Json格式：
...
<h6>15.接下来对于/build/example/conf中的文件进行修改，目录如下
...
<h6>16.接下来再为`train.index`构建**语义索引库**（在`AnyQ/build`下执行）：
